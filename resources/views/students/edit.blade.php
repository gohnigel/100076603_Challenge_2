    ...
    <form action="/students/{{ $student->id }}" method="post">
        ...
        <fieldset>
            ...
            <p>
                ...
                <input type="text" name="name" id="name" maxlength="255" required value="{{ $student->name }}">
                ...
                <input type="email" name="email" id="email" required maxlength="255" value="{{ $student->email }}">
                <span class="manager">*</span>
            ...
            <p>
                ...
                <select name="school_id" id="school_id" required>
                    @foreach ($schools as $school)
                        <option value="{{ $school->id }}" @if( $student->school_id == $school->id) selected @endif>{{ $school->school_name }}</option>
                    @endforeach
                </select>
            ...
            <input type="hidden" name="approve" value="Not Approved">
